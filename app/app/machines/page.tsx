          ...
          <div className="mt-4 flex items-center justify-between">
            {isAvailable ? (
              <Link
                ...
                className="w-full text-center rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
              >
                Select & Pay
              </Link>
            ) : isRunning && session ? (
              <div className="w-full text-center rounded-md bg-blue-50 px-3 py-2 text-sm font-medium text-blue-700 ring-1 ring-inset ring-blue-700/10">
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            ...
            {washers.every(m => m.status !== "AVAILABLE") && (
              <Link href="/app/queue/join?type=WASHER" className="text-sm text-blue-600 hover:text-blue-500 font-medium">
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            ...
            {dryers.every(m => m.status !== "AVAILABLE") && (
              <Link href="/app/queue/join?type=DRYER" className="text-sm text-blue-600 hover:text-blue-500 font-medium">
